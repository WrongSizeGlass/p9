...
public class BiasFoundation : MonoBehaviour
{
    float[,] DefaultBias = new float[7, 7] { 
    //______________Triangle |  Cube   | Thick  | Thin    | Blank   | Striped  | Squard |
    /*0 Triangle */{  2, /*  |*/ (-1), /*|*/ 2, /*| */(-2),/* | */ 1,/* | */(-1),  /*|*/(-2) } ,   
    /*1 Cube     */{ (-1), /*  |*/ 2, /* |*/ 2, /*| */(-2),/* | */ 1,/* | */(-1),  /*|*/(-2) } ,
    /*2 Thick */   {  1, /*  |*/ (-1),/* |*/ 3, /*| */(-3),/* | */ 1,/* | */(-1),  /*|*/(-2) } ,
    /*3 Thin */    {  1, /*  |*/ (-1),/* |*/ (-3),/*| */ 3,/* | */ 1,/* | */(-1),  /*|*/(-2) } ,
    /*4 Blank */   {  1, /*  |*/ (-1),/* |*/ 2, /*| */(-2),/* | */ 2,/* | */(-1),  /*|*/(-2) } ,
    /*5 Striped */ {  1, /*  |*/ (-1),/* |*/ 2, /*| */(-2),/* | */(-1),/* | */ 2,  /*|*/(-1) } ,
    /*6 Squard */  {  1, /*  |*/ (-1),/* |*/ 2, /*| */(-2),/* | */(-2),/* | */(-1),  /*|*/ 3 }
    };
    ...
    private static void setPlayer() {
            ...
            {
                setPlayerOnce = true;
                randomNr = UnityEngine.Random.Range(1, 3);
                playerIsSet = randomNr % 2 == 1;
            } else {
    ...
    void Start()
    {
        ...
        if (!q)
        {
            if (this.tag == "Player")
            {
                ...
                Debug.Log("player first " + FirstPlaythrough);
                if (!q)
                {
                    if (FirstPlaythrough)
                    {
    ...
    public float GetGeneralBias (float geoBias, float thickBias, float patBias){
        myBiases.Clear();
        myBiases = new List<float>();
        ...
        float thickCalc = Mathf.Pow(myBiases[2], 2.0f) - myBiases[3];
      ...
      //  Debug.LogError(this.name + " geoCalc " + geoCalc + " thickCalc " + thickCalc + " patterenCalc " + patterenCalc + " abc");
        ...
        if (biasCalc < 0){
            biasCalc = Mathf.Pow(biasCalc * -1, 1.0f / 3.0f)*-1;
        }else{
